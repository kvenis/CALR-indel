...
R129_bc065_s5xlA_reads <- read.delim(file="/Volumes/Pathology/Molecular Pathology/Test Development/Bioinformatics_Projects/CALR_indels/out_dir/R129_bc065_s5XLA_calr_readLenths.txt",
...
R40_bc063_s5xlB_reads <- read.delim(file="/Volumes/Pathology/Molecular Pathology/Test Development/Bioinformatics_Projects/CALR_indels/out_dir/R40_MPCP_BC063/R40_bc063_s5xlb_calr_readLengths.txt",
                                    sep="", header=FALSE, skip=1)
...
lengths
write.txt(data, file = "/Volumes/Pathology/Molecular Pathology/Test Development/Bioinformatics_Projects/CALR_indels/out_dir/R40_MPCP_BC063/R40_bc063_s5xlB.txt")
names(data) <- c("No_of_reads","read_length","percentage_of_reads","indel_length")
data

##R209-bc041-S5xlA
R209_bc041_s5xlA_reads <- read.delim(file="/Volumes/Pathology/Molecular Pathology/Test Development/Bioinformatics_Projects/CALR_indels/out_dir/R209-S5XLA/R209-bc041-S5xla-calr-exon8_readLength.txt",
                                    sep="", header=FALSE, skip=1)
...
names(data) <- c("No_of_reads","read_length","percentage_of_reads","indel_length")
data
write.table(data, file = "/Volumes/Pathology/Molecular Pathology/Test Development/Bioinformatics_Projects/CALR_indels/out_dir/R209-S5XLA/R209_bc041_s5xlA.txt", sep = "\t", row.names = FALSE)